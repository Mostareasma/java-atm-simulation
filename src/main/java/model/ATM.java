...
public class ATM {
    ...
    public ATM(int num200Bills, int num100Bills) {
        this.balance = num200Bills * Bills.BILL_200.getValue() + num100Bills * Bills.BILL_100.getValue();
    ...
    public void deposit(int num200Bills, int num100Bills){
